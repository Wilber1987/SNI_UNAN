...
import { NotificacionesView } from "./Views/MNotificaciones/NotificacionesView.js";
...
class MasterDomDetaills extends ComponentsManager {
    constructor(MainComponent, AsideComponent = null) {
        super();
        const Main = new MainClass(MainComponent);
        DOMManager.MainContainer = Main;        
                ...
                Elements: [
                    {
                        ...
                        name: "Notificaciones", url: "#", icon: Icons.NOTIFICATIONS,
                        action: (ev) => {
...
customElements.define('w-header', headerClass);
class AsideClass {
...
customElements.define('w-main', MainClass);
const Icons = {
    NOTIFICATIONS: "./WDevCore/Media/Icons/bell.png",
