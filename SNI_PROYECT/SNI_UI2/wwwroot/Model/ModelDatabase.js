...
class Tbl_Distinciones {
	...
	Id_Investigador = { type: "number", hidden: true };
	Id_Tipo_Distincion = { type: "Select", Dataset: [] }
	Descripcion = { type: "text" };
	fecha = { type: "date" };
	Id_Institucion =  { type: "Select", Dataset: [] };
	Montos = { type: "string" };
}
...
class Tbl_Evento {
	...
	Id_Tipo_Evento = { type: "Select", Dataset: [] }
	Nombre = { type: "text" };
	Id_Pais = { type: "Select", Dataset: [] }
...
class Tbl_Formacion_Academica {
	...
	Id_TipoEstudio = { type: "Select", Dataset: [] };
	Id_Institucion = { type: "Select", Dataset: [] };
	Titulo = { type: "text" };
