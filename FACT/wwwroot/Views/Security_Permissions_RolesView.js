...
class Security_Permissions_RolesView extends HTMLElement {
   constructor(props) {
       ...
       this.MainComponent = new WTableComponent({ ModelObject: new Security_Permissions_Roles(), Dataset: [], Options: {
           Add: true, UrlAdd: "../api/Admin/saveSecurity_Permissions_Roles",
           Edit: true, UrlUpdate: "../api/Admin/updateSecurity_Permissions_Roles",
           Search: true, UrlSearch: "../api/Admin/getSecurity_Permissions_Roles"
       }})
