...
import { WSlide } from "./WDevCore/WComponents/WSlide.js";
...
class headerClass extends HTMLElement {
    constructor() {
        ...
        const ArrayImage = [
            { url: "./Media/IMG/Banner/Banner1.jpg" },
            { url: "./Media/IMG/Banner/Banner2.jpg" },
            { url: "./Media/IMG/Banner/Banner3.jpg" }
        ];
        this.append(WRender.createElement({
            type: 'div', props: { class: 'BannerClass' }, children: [
                ...
                //{ type: 'img', props: { src: "./Media/IMG/Banner.jpg", class: 'bannerImage' } },
            ]
        }));
        ...
        props: {
            ClassList: [
                new WCssClass(".AppHeader", {
                    ...
                    "align-items": "center",
                    "padding-left": 20
                }), new WCssClass(".AppHeader .imgLogo", {
                    display: "block",
                    height: "100%"
                }), new WCssClass(".AppHeader .logDv", {
                    padding: 8,
                }), new WCssClass(".AppHeader .BannerClass", {
                    display: "block",
                    height: "100%",
                    "grid-column": "1/3"
                }),
...
customElements.define('w-aside', AsideClass);
const Icons = {
...
class FooterNavigator extends HTMLElement {
    constructor() {
        super();
    ...
    Options = [
        {
            tagName: 'img', src: this.icons.home, onclick: async () => {
                const { HomeView } = await import("./Views/HomeView.js");
                DOMManager.NavigateFunction("HomeClass", new HomeView());
            }
        }, {
            tagName: 'img', src: this.icons.foro, onclick: async () => {
                //----
            }
        }, {
            tagName: 'img', src: this.icons.perfil, onclick: async () => {
                if (!WSecurity.Auth()) {
                    WSecurity.LoginIn();
                    return;
                }
                DOMManager.NavigateFunction("PerfilView", new PerfilView(WSecurity.User()));
            }
        }, {
            tagName: 'img', src: this.icons.info, onclick: async () => {
                //----
            }
        }
    ];
}
customElements.define('w-footer', FooterNavigator);

class Layout extends (ComponentsManager, HTMLElement) {
            ...
            ClassList: [
                ...
                ClassList: [
                    new WCssClass(`.App`, {
                        ...
                        top: 0,
                        bottom: 0
                    }), new WCssClass(".AppMain, .AppAside", {
                        overflow: "auto",
                        "overflow-x": "hidden"
                    }), new WCssClass(" .AppAside", {
                        display: "none"
